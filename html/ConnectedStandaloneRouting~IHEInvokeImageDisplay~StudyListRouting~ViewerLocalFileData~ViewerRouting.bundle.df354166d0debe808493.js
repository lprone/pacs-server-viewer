...
// EXTERNAL MODULE: /usr/src/app/node_modules/react-router-dom/esm/react-router-dom.js
...
var HotkeysPreferences = __webpack_require__(1057);
...
function HotkeysPreferences_HotkeysPreferences(_ref2) {
  ...
  })) : 'Hotkeys definitions is empty'), react_default.a.createElement(src["E" /* TabFooter */], {
...
// EXTERNAL MODULE: /usr/src/app/platform/core/src/redux/index.js + 11 modules
var redux = __webpack_require__(243);

// EXTERNAL MODULE: ./components/UserPreferences/WindowLevelPreferences.styl
var WindowLevelPreferences = __webpack_require__(1058);
...
function WindowLevelPreferences_WindowLevelPreferences(_ref) {
  ...
  }))), react_default.a.createElement(src["E" /* TabFooter */], {
    onResetPreferences: onResetPreferences,
    onSave: onSave,
    onCancel: onClose,
    hasErrors: hasErrors,
...
// EXTERNAL MODULE: /usr/src/app/platform/i18n/src/index.js + 23 modules
var i18n_src = __webpack_require__(110);

// EXTERNAL MODULE: ./components/UserPreferences/GeneralPreferences.styl
var GeneralPreferences = __webpack_require__(1059);
...
var UserPreferences = __webpack_require__(1060);
...
function UserPreferences_UserPreferences(_ref) {
  ...
  return react_default.a.createElement(src["D" /* TabComponents */], {
    tabs: tabs,
...
var Header = __webpack_require__(1061);
...
function Header_Header(props) {
  ...
  }, t('')), react_default.a.createElement("div", {
  ...
  }, t('')), react_default.a.createElement(src["f" /* Dropdown */], {
    title: t('Options'),
    list: options,
    align: "right"
  }))));
...
/* harmony default export */ var components_Header_Header = (Object(es["d" /* withTranslation */])(['Header', 'AboutModal'])(Object(react_router["g" /* withRouter */])(Object(src["U" /* withModal */])(Header_Header))));
